	...
	public void depositMoney() {
		...
		for(int i=0 ; i<numOfAccount ; i++) {
			...
			if(accountNo.compareTo(myAccount[i].accountID)==0) {
				if(myAccount[i].accMoney>0 && myAccount[i].grade == "A") {
					myAccount[i].accMoney = myAccount[i].accMoney+
						(int)(myAccount[i].accMoney * (((myAccount[i].rate)+7)/100))+deposit;
				}
				if(myAccount[i].accMoney>0 && myAccount[i].grade == "B") {
					myAccount[i].accMoney = myAccount[i].accMoney+
						(int)(myAccount[i].accMoney * (((myAccount[i].rate)+4)/100))+deposit;
				}
				if(myAccount[i].accMoney>0 && myAccount[i].grade == "C") {
					myAccount[i].accMoney = myAccount[i].accMoney+
						(int)(myAccount[i].accMoney * (((myAccount[i].rate)+2)/100))+deposit;
				}
